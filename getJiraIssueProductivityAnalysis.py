...
def getIssueListFromJql(jql):
    jira_api = 'https://wantedlab.atlassian.net/rest/issueNav/1/issueTable'
    headers = {
        'Authorization': 'Basic c2V1bmdob29uQHdhbnRlZGxhYi5jb206V05YVFJqcTlaNHJ1dTROckFzZTQyQzRB',
...
def getIssueStatusHistory(key):
    jira_api = 'https://wantedlab.atlassian.net/rest/gira/1/'
    headers = {'Authorization': 'Basic c2V1bmdob29uQHdhbnRlZGxhYi5jb206V05YVFJqcTlaNHJ1dTROckFzZTQyQzRB'}
    data = {
...
def getIssueInfo(key):
    jira_api = 'https://wantedlab.atlassian.net/rest/graphql/1/'
    headers = {'Authorization': 'Basic c2V1bmdob29uQHdhbnRlZGxhYi5jb206V05YVFJqcTlaNHJ1dTROckFzZTQyQzRB'}
